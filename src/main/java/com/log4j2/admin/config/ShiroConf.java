...
import com.log4j2.admin.shiro.ShiroSessionListener;
...
public class ShiroConf {
     ...
     */
    @Bean
    public MethodInvokingFactoryBean getMethodInvokingFactoryBean(@Qualifier("shiroRealm") ShiroRealm shiroRealm){
